...
thread avoid the burden of taking care of race conditions by the programmer.
...
The use of it followed by the clause \texttt{schedule} controls its behavior in detail. This
...
will mask the original variable located outside the thread. 
...
be able to change its value. (readsourcefile.c as example)
...
kind of functionality at the instruction set level, making the use of \texttt{atomic}
fast. 
